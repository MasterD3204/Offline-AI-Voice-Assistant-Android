...
| `https://huggingface.co/litert-community/Qwen2.5-1.5B-Instruct/blob/main/Qwen2.5-1.5B-Instruct_multi-prefill-seq_q8_ekv4096.litertlm` | Model LLM lượng tử hóa (1.5GB) | `/sdcard/Download/` |
